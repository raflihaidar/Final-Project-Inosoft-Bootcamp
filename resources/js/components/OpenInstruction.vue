<template>
      ...
      <div class="card-body">
        ...
        <ul class="nav nav-tabs">
          ...
          <li class="nav-item" style="float: right;">
            <button style="border-color:#d4d4d4; font-weight:bold" id="putih" class="btn btn-outline-secondary btn-sm" v-on:click="ExportExcel('tcomplete', 'Tab-complete')"><i id="biru"            
  ...
  .table-hovers tbody tr:hover td, .table-hover tbody tr:hover th {
    color: #00bfbf !important;
  }
