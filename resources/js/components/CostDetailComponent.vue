			...
			<table>
				...
				<tbody>
					...
					<td><input-field type="number" color="grey" width="100px" height="40px" placeholder="Enter a number" v-model="item.qty" /></td> -->
						<td><input class="description" type="text" placeholder="Enter Description"
						...
						<td><input class="unit-price" type="number" placeholder="Enter Unit Price"
								v-model.number="item.unitPrice"></td>
						...
						<td>{{ getTotal(item) }}</td>
						<td>
							<button-component icon="fa fa-minus " width="50px" height="50px" color="grey"
								@click="removeRow(index)" :disabled="items.length === 1" />
						</td>
						<td>
