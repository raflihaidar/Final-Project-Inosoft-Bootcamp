          ...
          <a id="open" class="nav-link active" href="#">Open</a>
                ...
                >
                    <div class="input-group input-group-sm">
                        ...
                        >
                            <i id="biru" class="fas fa-search"> </i>
                        </span>
                        <input
                            class="form-control"
                            type="text"
                ...
                <li class="nav-item" style="float: right">
                    <button
                        style="border-color: #d4d4d4; font-weight: bold"
                        id="putih"
                        class="btn btn-outline-secondary btn-sm"
                        v-on:click="ExportExcel('tcomplete', 'Tab-complete')"
                    >
                        <i id="biru" class="fa-solid fa-file-export"></i>
                        Export
                    </button>
                </li>
            </ul>
            ...
            <div class="overflow-auto">
                ...
                <table
                    id="tcomplete"
                    class="sortable batas table table-hovers text-nowrap"
                >
                    <thead class="text-bg-secondary">
                        <tr>
                            <th>
                                Instruction ID
                                <div
                                    class="btn-group-vertical cursor-pointer"
                                    role="group"
                                >
                                    <div
                                        style="
                                            ...
                                            padding-left: 2px;
                                        "
                                        class="btn1 btn-group-vertical"
                                        role="group"
                                        aria-label="Vertical radio toggle button group"
                                    >
                                        <i
                                            style="color: white"
                                            class="bi bi-caret-up-fill sort-up"
                                            v-on:click="sortRecordsAsc(0)"
                                        ></i>
                                        <a
                                            style="color: white"
                                            class="bi bi-caret-down-fill sort-down"
                                            v-on:click="sortRecordsDesc(0)"
                                        ></a>
                                    </div>
                                </div>
                            </th>
                                ...
                                >
                                    ...
                                    >
                                        <i
                                            style="color: white"
                                            class="bi bi-caret-up-fill sort-up"
                                            v-on:click="sortRecordsAsc(1)"
                                        ></i>
                                        <a
                                            style="color: white"
                                            class="bi bi-caret-down-fill sort-down"
                                            v-on:click="sortRecordsDesc(1)"
                                        ></a>
                                    </div>
                                </div>
                            </th>
                                ...
                                >
                                    ...
                                    >
                                        <i
                                            style="color: white"
                                            class="bi bi-caret-up-fill sort-up"
                                            v-on:click="sortRecordsAsc(2)"
                                        ></i>
                                        <a
                                            style="color: white"
                                            class="bi bi-caret-down-fill sort-down"
                                            v-on:click="sortRecordsDesc(2)"
                                        ></a>
                                    </div>
                                </div>
                            </th>
                                ...
                                >
                                    ...
                                    >
                                        <i
                                            style="color: white"
                                            class="bi bi-caret-up-fill sort-up"
                                            v-on:click="sortRecordsAsc(3)"
                                        ></i>
                                        <a
                                            style="color: white"
                                            class="bi bi-caret-down-fill sort-down"
                                            v-on:click="sortRecordsDesc(3)"
                                        ></a>
                                    </div>
                                </div>
                            </th>
                                ...
                                >
                                    ...
                                    >
                                        <i
                                            style="color: white"
                                            class="bi bi-caret-up-fill sort-up"
                                            v-on:click="sortRecordsAsc(4)"
                                        ></i>
                                        <a
                                            style="color: white"
                                            class="bi bi-caret-down-fill sort-down"
                                            v-on:click="sortRecordsDesc(4)"
                                        ></a>
                                    </div>
                                </div>
                            </th>
                                ...
                                >
                                    ...
                                    >
                                        <i
                                            style="color: white"
                                            class="bi bi-caret-up-fill sort-up"
                                            v-on:click="sortRecordsAsc(5)"
                                        ></i>
                                        <a
                                            style="color: white"
                                            class="bi bi-caret-down-fill sort-down"
                                            v-on:click="sortRecordsDesc(5)"
                                        ></a>
                                    </div>
                                </div>
                            </th>
                                ...
                                >
                                    ...
                                    >
                                        <i
                                            style="color: white"
                                            class="bi bi-caret-up-fill sort-up"
                                            v-on:click="sortRecordsAsc(6)"
                                        ></i>
                                        <a
                                            style="color: white"
                                            class="bi bi-caret-down-fill sort-down"
                                            v-on:click="sortRecordsDesc(6)"
                                        ></a>
                                    </div>
                                </div>
                            </th>
                                ...
                                >
                                    ...
                                    >
                                        <i
                                            style="color: white"
                                            class="bi bi-caret-up-fill sort-up"
                                            v-on:click="sortRecordsAsc(7)"
                                        ></i>
                                        <a
                                            style="color: white"
                                            class="bi bi-caret-down-fill sort-down"
                                            v-on:click="sortRecordsDesc(7)"
                                        ></a>
                                    </div>
                                </div>
                            </th>
                                ...
                                >
                                    ...
                                    >
                                        <i
                                            style="color: white"
                                            class="bi bi-caret-up-fill sort-up"
                                            v-on:click="sortRecordsAsc(8)"
                                        ></i>
                                        <a
                                            style="color: white"
                                            class="bi bi-caret-down-fill sort-down"
                                            v-on:click="sortRecordsDesc(8)"
                                        ></a>
                                    </div>
                                </div>
                            </th>
                    ...
                    <tbody class="cursor-pointer">
                        <tr v-for="(item, index) in items" v-bind:key="index">
                            ...
                            <td>
                                <p
                                    id="btn-cancel"
                                    v-if="item[8] == 'Completed'"
                                    class="btn btn-success badge badge-pill bg-success"
                                    v-on:click="pushComplete(item[0])"
                                >
                                    {{ item[8] }}
                                </p>
                                ...
                                >
                                    <p
                                        id="btn-cancel"
                                        class="btn btn-secondary badge badge-pill bg-secondary"
                                        v-on:click="pushCancel(item[0])"
                                    >
                                        {{ item[8] }}
                                        <a
...
const performSearch = (items, term) => {
    const results = items.filter((item) =>
        item.join(" ").toLowerCase().includes(term.toLowerCase())
    );
    return results;
};
