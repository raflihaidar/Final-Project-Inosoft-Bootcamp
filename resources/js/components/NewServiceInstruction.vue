<template>
                        <!-- tempat tabel -->
                        <div class="container-box shadow" style="margin-top:30px;">
                            <div class="content-box">
                                ...
                                <!--                                        section break line                                -->
                                <div class="cost-detail py-3 border-bottom">
                                    <p>
                                        <strong style="font-size: large"
                                            >Cost Detail</strong
                                        >
...
import TransportComponent from "./TransportComponent.vue";
