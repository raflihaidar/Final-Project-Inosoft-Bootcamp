...
<!--                                        section break line                                -->
            ...
            <div class="buttons" style="display: flex; flex-direction: row; justify-content: flex-end;">
                ...
                <button-component style=" margin: 5px;" width="150px"  height="40px" color="blue" text="Submit" @click="tes()" />
            </div>
        </div>
    </div>
</template>
  ...
  export default {
    ...
    methods: {
        ...
        updateTemplateData() {
            ...
            axios.patch(`http://127.0.0.1:8000/api/patchData/${this.selectedTemplate.id}`, updatedTemplate)
            .then(response => {
        ...
        async tes(){
          const response = await axios.post("http://127.0.0.1:8000/api/instruction/add_draft");
          console.log(response.data);
        },
      ...
      try {
        const response = await axios.post('http://127.0.0.1:8000/api/instruction/add', payload);
        console.log(response.data);
