        ...
        <div class="content-box">
            <div class="scope-of-work">
                <p>
                    ...
                    No
                    <a class="button" href="#scope-modal">modify</a>
                    </label>
                </p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div v-for="(displayedSection, displayedSectionIndex) in selectedTemplateItems" :key="displayedSectionIndex">
                                        <p>testing{{ displayedSection.name }}</p>
                                        <tr  v-for="(displayedItem, displayedItemIndex) in displayedSection.items" :key="displayedItemIndex">
                                            <div>
                                                <td  v-if="displayedItem.checked">testing{{ displayedItem.text }}</td>
                                                <td  v-else></td>
                                                <td  v-if="displayedItem.checked">testing{{ displayedItem.description }}</td>
                                                <td  v-else></td>
                                            </div>
                                        </tr>
                                    </div>
                        ...
                        <div class="content">
                            <div class="SoW-content">
                                ...
                                <div style="float: right; ">
                                    ...
                                    <button-component style="display: inline-block; margin-right: 10px;" width="150px"  height="40px" color="blue" :font-color="'black'" text="Cancel" />
                                    <button-component style="display: inline-block;" width="150px"  height="40px" color="transparent" text="Submit" />
                                </div>
                            </div>
                        </div>
                    </div>
...
<!--                                        section break line                                -->
            ...
            <!--                                        section break line                                -->
            <div class="attachment-and-notes"> 
                <div class="container">
                    <div class="left">
                        ...
                        <button-component  icon="fa fa-plus" text="Add Attachment" font-size="15" width="200px" height="37px" color="blue" @click.native="openFileInput"/>
                    </div>
                    <div class="right">
                        <h6>Notes</h6>
